...
def analyse_name_alignment(
    ...
    *,
    ...
    if score_bits == 0:
        ...
        label = "Signal"
    return NameAnalysis(score=score_bits, label=label, details=details)
...
def analyse_gender(
    ...
    *,
    ...
    elif score_bits in (1, 4, 5):
        label = "Female leaning"
    elif score_bits in (2, 8, 10):
        label = "Male leaning"
    elif score_bits in (3, 6, 7, 9, 11, 12, 13, 14, 15):
        label = "Ambiguous"
    else:
        label = "Signal"

    return GenderAnalysis(score=score_bits, label=label, details=details)
